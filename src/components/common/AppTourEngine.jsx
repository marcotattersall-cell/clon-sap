...
export const TOUR_STEPS = [
  {
    id: 'INTRO',
    title: 'Bienvenido a AXOMIRA INTELLIGENT CLOUD ERP',
    subtitle: 'El ERP de Próxima Generación para la Industria & Minería',
    tab: 'LAUNCHPAD',
    narration: 'Bienvenido a la era de la gestión empresarial inteligente. Descubre AXOMIRA INTELLIGENT CLOUD ERP: la arquitectura ERP cloud-native diseñada para transformar la operativa de mantenimiento, inventarios y recursos humanos en tiempo real.',
    icon: Sparkles,
  ...
  },
  {
    ...
    subtitle: 'Gestión de Órdenes de Trabajo (axomira:mantenimiento:ordenes)',
    tab: 'WORK_ORDERS',
    narration: 'Optimiza la disponibilidad operacional de tu maquinaria. Asigna órdenes de trabajo preventivas y correctivas, monitorea la salud estructural de tus equipos y reduce el tiempo de parada no programada con el slug axomira:mantenimiento:ordenes.',
    icon: Wrench,
  ...
  },
  {
    ...
    subtitle: 'Control de Stock & Movimientos (axomira:inventario:movimientos)',
    tab: 'INVENTORY',
    narration: 'Gestiona tu cadena de suministro sin fricción. Registra salidas y entradas de mercancía con el flujo axomira:inventario:movimientos (#inv-mov) de forma atómica, automatiza reaprovisionamientos y mantiene trazado exacto de stock.',
    icon: Package,
