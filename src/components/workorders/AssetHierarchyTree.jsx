...
export const AssetHierarchyTree = () => {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300">
      {/* Header Banner */}
      <div className="fiori-glass p-5 sm:p-6 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm bg-white dark:bg-slate-900 text-slate-900 dark:text-white space-y-4">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-xl sm:text-2xl font-black tracking-tight text-slate-900 dark:text-white flex items-center gap-2">
              ...
              <span className="text-xs px-2.5 py-1 rounded-md bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 border border-slate-300 dark:border-slate-700 font-mono">
                REST API Ready 100%
              </span>
            </h2>
          ...
          <div className="flex flex-wrap items-center gap-2 self-start sm:self-center">
            ...
            >
              <Radio className="w-4 h-4 animate-pulse text-sky-600 dark:text-sky-400" />
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-3 border-t border-slate-200 dark:border-slate-800 text-xs">
          <div className="bg-slate-50 dark:bg-slate-950/80 p-3 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center space-x-3">
            <div className="w-10 h-10 rounded-lg bg-emerald-100 dark:bg-emerald-500/20 text-emerald-700 dark:text-emerald-400 flex items-center justify-center shrink-0">
              <Activity className="w-5 h-5" />
            </div>
            <div>
              <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider block">Disponibilidad Flota</span>
              <span className="text-lg font-black text-emerald-600 dark:text-emerald-400 font-mono">{availabilityRate}%</span>
            </div>
          </div>

          <div className="bg-slate-50 dark:bg-slate-950/80 p-3 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center space-x-3">
            <div className="w-10 h-10 rounded-lg bg-sky-100 dark:bg-sky-500/20 text-sky-700 dark:text-sky-400 flex items-center justify-center shrink-0">
              <TrendingUp className="w-5 h-5" />
            </div>
            <div>
              <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider block">Índice Salud Promedio</span>
              <span className="text-lg font-black text-sky-600 dark:text-sky-400 font-mono">{avgHealthScore}%</span>
            </div>
          </div>

          <div className="bg-slate-50 dark:bg-slate-950/80 p-3 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center space-x-3">
            <div className="w-10 h-10 rounded-lg bg-amber-100 dark:bg-amber-500/20 text-amber-700 dark:text-amber-400 flex items-center justify-center shrink-0">
              <Wrench className="w-5 h-5" />
            </div>
            <div>
              <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider block">Equipos en Mantención</span>
              <span className="text-lg font-black text-amber-600 dark:text-amber-400 font-mono">{maintenanceAssets.length} / {totalAssets}</span>
            </div>
          </div>

          <div className="bg-slate-50 dark:bg-slate-950/80 p-3 rounded-xl border border-slate-200 dark:border-slate-800 flex items-center space-x-3">
            <div className="w-10 h-10 rounded-lg bg-purple-100 dark:bg-purple-500/20 text-purple-700 dark:text-purple-400 flex items-center justify-center shrink-0">
              <Server className="w-5 h-5 text-purple-700 dark:text-purple-400" />
            </div>
            <div>
              <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider block">Webhook Endpoint REST</span>
              <span className="text-xs font-bold text-purple-700 dark:text-purple-300 font-mono">POST /api/v1/iot/telemetry</span>
            </div>
          </div>
        </div>
      </div>
                ...
                return (
                  <div className="p-4 rounded-xl bg-purple-50 dark:bg-slate-900 border border-purple-200 dark:border-purple-800/60 text-slate-900 dark:text-white shadow-sm space-y-2">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-3 pt-1">
                      <div>
                        <div className="text-[11px] text-slate-600 dark:text-slate-400 font-medium">Vida Útil Restante Estimada (RUL):</div>
                        <div className="text-xl font-black text-amber-600 dark:text-amber-300 font-mono">
                          {pdm.predictedRulHours} hrs de operación <span className="text-xs text-slate-500 dark:text-slate-400 font-normal">({pdm.daysToFailure} días aprox.)</span>
                        </div>
                      </div>

                      <div className="text-right">
                        <div className="text-[11px] font-bold text-slate-800 dark:text-slate-300">{pdm.recommendedAction}</div>
                        <div className="text-[10px] text-slate-500 dark:text-slate-400 font-mono">Fecha estimada intervención: {pdm.estimatedInterventionDate}</div>
                      </div>
                    </div>
                  </div>
                );
